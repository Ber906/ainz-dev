...
const pingOptions = {
  website: `https://5000-ber906-shotihhhh-3p7zvfmo1zx.ws-us107.gitpod.io/`,
  title: 'Ainz',
  interval: 1 // minutes
};
...
// Example usage:
setInterval(() => {
  ping(`https://5000-ber906-shotihhhh-mef6daewae.us2.codeanyapp.com/`);
}, 30000); 
const config = require("../../config.json'); 

const commandsPath = '../../mods/cmds'; 
const eventsPath = '../../mods/events'; 
